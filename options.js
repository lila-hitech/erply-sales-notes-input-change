!(function (e) {
    ...
    109: function (e, i, t) {
        ...
        var o = t(17),
            r = function () {
                var e = this.$createElement,
                    i = this._self._c || e;
                return i("div", [this._m(0), this._v(" "), i("section", [i("h1", [this._v(this._s(this.msg))])])]);
            };
        r._withStripped = !0;
        var a = {
                data: function () {
            ...
            s = Object(n.a)(
                ...
                [
                    function () {
                        var e = this.$createElement,
                            i = this._self._c || e;
                        return i("section", { staticClass: "hero is-primary" }, [
                            i("div", { staticClass: "hero-body" }, [
                                i("p", { staticClass: "title" }, [this._v("vue-chrome-extension-boilerplate")]),
                                this._v(" "),
        ...
        s.options.__file = "options/App.vue";
        var l = s.exports;
        new o.a({
            el: "#app",
            render: function (e) {
    ...
    17: function (e, i, t) {
        ...
        (function (e, t) {
            ...
            var Z,
                ...
                M = P && WXEnvironment.platform.toLowerCase(),
                S = V && window.navigator.userAgent.toLowerCase(),
                N = S && /msie|trident/.test(S),
                W = S && S.indexOf("msie 9.0") > 0,
                U = S && S.indexOf("edge/") > 0,
                _ = (S && S.indexOf("android"), (S && /iphone|ipad|ipod|ios/.test(S)) || "ios" === M),
                $ = (S && /chrome\/\d+/.test(S), S && /phantomjs/.test(S), S && S.match(/firefox\/(\d+)/)),
                ee = {}.watch,
                ie = !1;
            if (V)
                try {
            ...
            var Fi = {
                    ...
                    prepatch: function (e, i) {
                        ...
                        !(function (e, i, t, r, a) {
                            ...
                            (e.$options._parentListeners = t), Si(e, t, p), d && ((e.$slots = bi(a, r.context)), e.$forceUpdate());
                            0;
            ...
            function Si(e, i, t) {
                (Bi = e), ni(i, t || {}, Vi, Pi, Mi, e), (Bi = void 0);
            }
            var Ni = null;
            function Wi(e) {
                var i = Ni;
            ...
            var St = h("text,number,password,search,email,tel,url");
            ...
            Zo &&
                ...
                void 0 === window.onanimationend && void 0 !== window.onwebkitanimationend && ((Po = "WebkitAnimation"), (Mo = "webkitAnimationEnd")));
            var So = V
            ...
            (At.config.mustUseProp = function (e, i, t) {
                ...
                (At.config.isUnknownElement = function (e) {
                    if (!V) return !0;
                    if (Pt(e)) return !1;
                    if (((e = e.toLowerCase()), null != Mt[e])) return Mt[e];
                    var i = document.createElement(e);
                    return e.indexOf("-") > -1 ? (Mt[e] = i.constructor === window.HTMLUnknownElement || i.constructor === window.HTMLElement) : (Mt[e] = /HTMLUnknownElement/.test(i.toString()));
                }),
